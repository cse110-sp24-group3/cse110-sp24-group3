!function(e, t) {
    ...
    var ee = function(e, t) {
        ...
        t && (n = r.slice(t.index + t[0].length),
    ...
    function Ce() {}
    function Se(e, t) {
        e = Object.create ? Object.create(e) : (Ce.prototype = e,
        new Ce);
        return t && he(t, e),
        e
    }
    ...
    function Ae(e, t, n) {
        for (; (n < 0 ? 0 < t : t < e.length) && Oe(e.charAt(t)); )
            t += n;
        return t
    }
    function De(e, t, n) {
    ...
    var Fe, Pe, Ee, Ie, ze, Re = function(e, t) {
        ...
        for (var O, A = [], D = 0; D < i; )
            if (Ie.test(o[D])) {
                ...
                for (var P = W; P < D; )
                    if (ze.test(o[P])) {
                        W < P && (A.splice(H, 0, new Be(1,W,P)),
                        H += F);
                        var I = P;
                        for (++P; P < D && ze.test(o[P]); ++P)
                            ;
                        A.splice(H, 0, new Be(2,I,P)),
                        H += F,
                        W = P
                    } else
                        ++P;
    ...
    : function(e) {
      ...
      , rt = "oncopy"in (l = M("div")) || (l.setAttribute("oncopy", "return;"),
    "function" == typeof l.oncopy)
      , it = null;
    var ot = {}
      , lt = {};
    function st(e) {
        if ("string" == typeof e && lt.hasOwnProperty(e))
            e = lt[e];
    ...
    function E(e, t) {
        ...
        return t.line > n ? F(n, W(e, n).text.length) : (e = W(e, (n = t).line).text.length,
    ...
    g.prototype.match = function(e, t, n) {
        var r;
        if ("string" != typeof e)
            return (r = this.string.slice(this.pos).match(e)) && 0 < r.index ? null : (r && !1 !== t && (this.pos += r[0].length),
            r);
        function i(e) {
    ...
    function Nt(t, n, r, e) {
        ...
        r.state), o = 0; o < t.state.overlays.length; ++o)
            !function(e) {
                r.baseTokens = a;
                var o = t.state.overlays[e]
                  ...
                  , s = 0;
                r.state = !0,
                It(t, n.text, o.mode, r, function(e, t) {
                    for (var n = l; s < e; ) {
                        var r = a[l];
    ...
    function Ot(e, t, n) {
        var r, i, o;
        return t.styles && t.styles[0] == e.state.modeGen || (r = At(e, H(t)),
    ...
    function At(n, r, e) {
        ...
        var o = function(e, t, n) {
            for (var r, i, o = e.doc, l = n ? -1 : t - (e.doc.mode.innerMode ? 1e3 : 100), s = t; l < s; --s) {
                ...
                var a = W(o, s - 1)
                  , u = a.stateAfter;
                if (u && (!n || s + (u instanceof Tt ? u.lookAhead : 0) <= o.modeFrontier))
                    return s;
    ...
    function Pt(e, t, n, r) {
        var i, o, l = e.doc, s = l.mode, a = W(l, (t = E(l, t)).line), u = At(e, t.line, n), c = new g(a.text,e.options.tabSize,u);
    ...
    function It(e, t, n, r, i, o, l) {
        var s = n.flattenSpans
          , a = (null == s && (s = e.options.flattenSpans),
        0)
          , u = null
    ...
    function Ut(e, t) {
        ...
        if (s)
            for (var f = 0; f < s.length; ++f) {
                var p = s[f];
                null != p.to && (p.to += u),
                null == p.from ? Gt(l, p.marker) || (p.from = u,
    ...
    function _t(e, t) {
        ...
        if (r)
            for (var i, o = 0; o < r.length; ++o)
                (i = r[o]).marker.collapsed && null == (t ? i.from : i.to) && (!n || $t(n, i.marker) < 0) && (n = i.marker);
        return n
    }
    function qt(e) {
        return _t(e, !0)
        ...
        if (o)
            for (var l = 0; l < o.length; ++l) {
                ...
                if (s.marker.collapsed) {
                    ...
                    if (!(0 <= u && c <= 0 || u <= 0 && 0 <= c) && (u <= 0 && (s.marker.inclusiveRight && i.inclusiveLeft ? 0 <= P(a.to, n) : 0 < P(a.to, n)) || 0 <= u && (s.marker.inclusiveRight && i.inclusiveLeft ? P(a.from, r) <= 0 : P(a.from, r) < 0)))
                        return 1
                }
            }
    }
    ...
    function hn(e, t) {
        ...
        for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
            ...
            function(e) {
                ...
                return te(e),
                n && n.left != n.right && (Je = t.right - n.right < 3)
                        ...
                        if (v == p) {
                            ...
                            if (!h || h.from == p)
                                for (var k = 0; k < y.length; ++k)
                                    pn(t, 0, y[k]);
                            if (h && (h.from || 0) == p) {
                                if (pn(t, (null == h.to ? f + 1 : h.to) - p, h.marker, null == h.from),
                                null == h.to)
                                    return;
                                h.to == p && (h = !1)
                            }
            ...
            o.styleClasses && (o.styleClasses.bgClass && (r.bgClass = oe(o.styleClasses.bgClass, r.bgClass || "")),
            o.styleClasses.textClass && (r.textClass = oe(o.styleClasses.textClass, r.textClass || ""))),
            0 == r.map.length && r.map.push(0, 0, r.content.appendChild((l = e.display.measure,
            o = void 0,
            null == Qe && (o = M("span", "​"),
        ...
        return x && (n = r.content.lastChild,
    ...
    function b(e, t) {
        var n = Ve(e, t);
        if (n.length)
            for (var r, i = Array.prototype.slice.call(arguments, 2), o = (vn ? r = vn.delayedCallbacks : yn ? r = yn : (r = yn = [],
            setTimeout(bn, 0)),
            0); o < n.length; ++o)
                !function(e) {
                    r.push(function() {
    ...
    function wn(e, t, n, r) {
        for (var i = 0; i < t.changes.length; i++) {
            ...
            if ("text" == o) {
                ...
                s.text = u.pre,
                u.bgClass != s.bgClass || u.textClass != s.textClass ? (s.bgClass = u.bgClass,
                s.textClass = u.textClass,
                Sn(l, s)) : a && (s.text.className = a)
            } else if ("gutter" == o)
                Ln(e, t, n, r);
            else if ("class" == o)
                Sn(e, t);
    ...
    function Sn(e, t) {
        ...
        n.background ? i ? n.background.className = i : (n.background.parentNode.removeChild(n.background),
        n.background = null) : i && (r = xn(n),
    ...
    function Ln(e, t, n, r) {
        ...
        if (e.options.lineNumbers || i) {
            ...
            !e.options.lineNumbers || i && i["CodeMirror-linenumbers"] || (t.lineNumber = l.appendChild(M("div", bt(e.options, n), "CodeMirror-linenumber CodeMirror-gutter-elt", "left: " + r.gutterLeft["CodeMirror-linenumbers"] + "px; width: " + e.display.lineNumInnerWidth + "px"))),
            i)
        ...
        if (t.widgets)
            for (var o = xn(n), l = 0, s = t.widgets; l < s.length; ++l) {
                var a = s[l]
                  ...
                  , c = (a.handleMouseEvents || u.setAttribute("cm-ignore-events", "true"),
                d = f = d = h = c = void 0,
                a)
                  , h = u
                  , d = n
                  , f = r;
                c.noHScroll && ((d.alignable || (d.alignable = [])).push(h),
                d = f.wrapperWidth,
                h.style.left = f.fixedPos + "px",
                c.coverGutter || (d -= f.gutterTotalWidth,
                h.style.paddingLeft = f.gutterTotalWidth + "px"),
                h.style.width = d + "px"),
                c.coverGutter && (h.style.zIndex = 5,
    ...
    function Mn(e) {
        if (null != e.height)
            return e.height;
        var t, n = e.doc.cm;
        return n ? (re(document.body, e.node) || (t = "position: relative;",
    ...
    function zn(e, t) {
        var n, r, i = H(t), o = In(e, i), e = (o && !o.text ? o = null : o && o.changes && (wn(e, o, i, ur(e)),
    ...
    function Rn(e, t, n, r, i) {
        ...
        if (t.cache.hasOwnProperty(l))
            ...
            (o = function(e, t, n, r) {
                ...
                if (3 == l.nodeType) {
                    for (var c = 0; c < 4; c++) {
                        for (; s && Oe(t.line.text.charAt(o.coverStart + s)); )
                            --s;
                        for (; o.coverStart + a < o.coverEnd && Oe(t.line.text.charAt(o.coverStart + a)); )
                            ++a;
                        if ((i = w && v < 9 && 0 == s && a == o.coverEnd - o.coverStart ? l.parentNode.getBoundingClientRect() : function(e, t) {
                            ...
                            if ("left" == t)
                                ...
                                for (var i = e.length - 1; 0 <= i && (n = e[i]).left == n.right; i--)
                                    ;
                            return n
                        }(le(l, s, a).getClientRects(), r)).left || i.right || 0 == s)
                            break;
                        a = s,
                        s -= 1,
                        u = "right"
                    ...
                    0 < s && (u = r = "right"),
                    i = e.options.lineWrapping && 1 < (n = l.getClientRects()).length ? n["right" == r ? n.length - 1 : 0] : l.getBoundingClientRect();
                !(w && v < 9) || s || i && (i.left || i.right) || (n = l.parentNode.getClientRects()[0],
                i = n ? {
                    left: n.left,
                ...
                e.options.singleCursorHeightPerLine || (g.rtop = n,
                g.rbottom = h);
                return g
    ...
    function _n(e, t, n, r, i) {
        ...
        r = r || "local";
        i = rn(t);
        return "local" == r ? i += On(e.display) : i -= e.display.viewOffset,
        "page" != r && "window" != r || (i += (t = e.display.lineSpace.getBoundingClientRect()).top + ("window" == r ? 0 : Yn(ae(e))),
    ...
    function qn(e, t, n) {
        ...
        var r = t.left
          , t = t.top
          , n = ("page" == n ? (r -= Xn(ae(e)),
        t -= Yn(ae(e))) : "local" != n && n || (r += (n = e.display.sizer.getBoundingClientRect()).left,
        t += n.top),
    ...
    function Qn(n, e, r, i, o, l) {
        ...
        var c = He(a, t, e)
          , h = We
          , c = u(t, c, "before" == e);
        return null != h && (c.other = u(t, h, "before" != e)),
        c
    }
    function Jn(e, t) {
        var n = 0
    ...
    function tr(e, t, n) {
        ...
        for (var l = W(r, i); ; ) {
            var s = function(n, e, t, r, i) {
                ...
                c && (c = (n.options.lineWrapping ? lr : or)(n, e, t, o, c, r, i),
                u = 1 != c.level,
                s = u ? c.from : c.to - 1,
                a = u ? c.to : c.from - 1);
                var h = null
                  ...
                  , c = De(function(e) {
                    ...
                    return t.top += l,
                    t.bottom += l,
                    ir(t, r, i, !1) && (t.top <= i && t.left <= r && (h = e,
                    d = t),
                    1)
                }, s, a)
                  , f = !1;
    ...
    function or(n, r, i, o, l, s, a) {
        ...
        ir(e = Qn(n, F(i, e ? u.from : u.to, e ? "after" : "before"), "line", r, o), s, a, !0) && e.top > a && (u = l[t - 1])),
        u
    }
    function lr(e, t, n, r, i, o, l) {
        for (var l = nr(e, t, r, l), s = l.begin, a = l.end, u = (/\s/.test(t.text.charAt(a - 1)) && a--,
        null), c = null, h = 0; h < i.length; h++) {
            var d, f = i[h];
            f.from >= a || f.to <= s || (d = (d = Rn(e, r, 1 != f.level ? Math.min(a, f.to) - 1 : Math.max(s, f.from)).right) < o ? o - d + 1e9 : d - o,
            (!u || d < c) && (u = f,
            c = d))
        }
    ...
    function fr(e, t, n, r) {
        ...
        i = tr(e, o, l);
        return r && 0 < i.xRel && (t = W(e.doc, i.line).text).length == i.ch && (n = S(t, t.length, e.options.tabSize) - t.length,
    ...
    function I(e, t, n, r) {
        ...
        var i, o = e.display, l = ((r = r || 0) && n < o.viewTo && (null == o.updateLineNumbers || o.updateLineNumbers > t) && (o.updateLineNumbers = t),
        e.curOp.viewChanged = !0,
        t >= o.viewTo ? Rt && en(e.doc, t) < o.viewTo && mr(e) : n <= o.viewFrom ? Rt && tn(e.doc, n + r) > o.viewFrom ? mr(e) : (o.viewFrom += r,
        o.viewTo += r) : t <= o.viewFrom && n >= o.viewTo ? mr(e) : t <= o.viewFrom ? (l = vr(e, n, n + r, 1)) ? (o.view = o.view.slice(l.index),
        o.viewFrom = l.lineN,
        o.viewTo += r) : mr(e) : n >= o.viewTo ? (l = vr(e, t, t, -1)) ? (o.view = o.view.slice(0, l.index),
        o.viewTo = l.lineN) : mr(e) : (l = vr(e, t, t, -1),
        i = vr(e, n, n + r, 1),
        l && i ? (o.view = o.view.slice(0, l.index).concat(mn(e, l.lineN, i.lineN)).concat(o.view.slice(i.index)),
        o.viewTo += r) : mr(e)),
        o.externalMeasured);
            ...
            a || function(i, e, t) {
                ...
                function s(n, g, m) {
                    ...
                    return function(e, t, n, r) {
                        ...
                        var i, o, l, s, a, u = "ltr" == n, c = w(e, u ? "left" : "right"), h = w(t - 1, u ? "right" : "left"), d = null == g && 0 == e, f = null == m && t == b, p = 0 == r, r = !C || r == C.length - 1;
                        h.top - c.top <= 3 ? (i = (k ? d : f) && p ? S : (u ? c : h).left,
                        a = (k ? f : d) && r ? L : (u ? h : c).right,
                        T(i, c.top, a - i, c.bottom)) : (a = u ? (o = k && d && p ? S : c.left,
                        l = k ? L : x(e, n, "before"),
                        s = k ? S : x(t, n, "after"),
                        k && f && r ? L : h.right) : (o = k ? x(e, n, "before") : S,
                        l = !k && d && p ? L : c.right,
                        s = !k && f && r ? S : h.left,
                        k ? x(t, n, "after") : L),
                ...
                {
                    var a;
                    n.line == r.line ? s(n.line, n.ch, r.ch) : (e = W(o, n.line),
                    a = W(o, r.line),
                    a = Jt(e) == Jt(a),
                    n = s(n.line, n.ch, a ? e.text.length + 1 : null).end,
                    e = s(r.line, a ? 0 : null, r.ch).start,
                    a && (n.top < e.top - 2 ? (T(n.right, n.top, null, n.bottom),
                    T(S, e.top, e.left, e.bottom)) : T(n.right, n.top, e.left - n.right, n.bottom)),
    ...
    function xr(e, t, n) {
        ...
        /\bcm-fat-cursor\b/.test(e.getWrapperElement().className) && (t = (t = Zn(e, t, "div", null, null)).right - t.left,
        i.style.width = (0 < t ? t : e.defaultCharWidth()) + "px"),
        r.other && ((i = n.appendChild(M("div", " ", "CodeMirror-cursor CodeMirror-secondarycursor"))).style.display = "",
        i.style.left = r.other.left + "px",
        i.style.top = r.other.top + "px",
        i.style.height = .85 * (r.other.bottom - r.other.top) + "px")
    }
    function Cr(e, t) {
    ...
    function Tr(e, t) {
        ...
        "nocursor" != e.options.readOnly && (e.state.focused || (O(e, "focus", e, t),
        e.state.focused = !0,
    ...
    function Mr(e, t) {
        e.state.delayingBlurEvent || (e.state.focused && (O(e, "blur", e, t),
        e.state.focused = !1,
    ...
    function Nr(e) {
        for (var t = e.display, n = t.lineDiv.offsetTop, r = Math.max(0, t.scroller.getBoundingClientRect().top), i = t.lineDiv.getBoundingClientRect().top, o = 0, l = 0; l < t.view.length; l++) {
            ...
            if (!s.hidden) {
                i += s.line.height,
                w && v < 8 ? (u = (h = s.node.offsetTop + s.node.offsetHeight) - n,
                n = h) : (u = (h = s.node.getBoundingClientRect()).bottom - h.top,
                !a && s.text.firstChild && (c = s.text.firstChild.getBoundingClientRect().right - h.left - 1));
                var h, a = s.line.height - u;
                if ((.005 < a || a < -.005) && (i < r && (o -= a),
                mt(s.line, u),
                Or(s.line),
                s.rest))
                    for (var d = 0; d < s.rest.length; d++)
                        Or(s.rest[d]);
                c > e.display.sizerWidth && ((a = Math.ceil(c / ar(e.display))) > e.display.maxLineLength && (e.display.maxLineLength = a,
    ...
    function Ar(e, t, n) {
        var r, i = n && null != n.top ? Math.max(0, n.top) : e.scroller.scrollTop, i = Math.floor(i - On(e)), o = n && null != n.bottom ? n.bottom : i + e.wrapper.clientHeight, i = vt(t, i), o = vt(t, o);
        return n && n.ensure && (r = n.ensure.from.line,
        n = n.ensure.to.line,
        r < i ? o = vt(t, rn(W(t, i = r)) + e.wrapper.clientHeight) : Math.min(n, t.lastLine()) >= o && (i = vt(t, rn(W(t, n)) - e.wrapper.clientHeight),
        o = n)),
        {
            from: i,
            to: Math.max(o, i + 1)
    ...
    function Dr(e, t) {
        ...
        (e.curOp && null != e.curOp.scrollTop ? e.curOp : n.scroller).scrollTop)
          , o = Fn(e)
          , l = {}
          , s = (t.bottom - t.top > o && (t.bottom = t.top + o),
        e.doc.height + An(n))
          , a = t.top < r
          , r = t.bottom > s - r
          , r = (t.top < i ? l.scrollTop = a ? 0 : t.top : t.bottom > i + o && ((a = Math.min(t.top, (r ? s : t.bottom) - o)) != i && (l.scrollTop = a)),
    ...
    function Xr(n) {
        ...
        n.display.scrollbars = new jr[n.options.scrollbarStyle](function(e) {
        ...
        if (e) {
            var t = function(e) {
                ...
                for (var n = e.ops, r = 0; r < n.length; r++) {
                    ...
                    i.mustUpdate = i.viewChanged || i.forceUpdate || null != i.scrollTop || i.scrollToPos && (i.scrollToPos.from.line < l.viewFrom || i.scrollToPos.to.line >= l.viewTo) || l.maxLineChanged && o.options.lineWrapping,
                    i.update = i.mustUpdate && new Qr(o,i.mustUpdate && {
                        top: i.scrollTop,
                ...
                for (var u = 0; u < n.length; u++) {
                    ...
                    c.barMeasure = Br(h),
                    d.maxLineChanged && !h.options.lineWrapping && (c.adjustWidthTo = En(h, d.maxLine, d.maxLine.text.length).left + 3,
                ...
                for (var f = 0; f < n.length; f++) {
                    ...
                    var p = n[f];
                    var g = p.cm;
                    null != p.adjustWidthTo && (g.display.sizer.style.minWidth = p.adjustWidthTo + "px",
                ...
                for (var v, y = 0; y < n.length; y++) {
                    ...
                    b.scrollToPos && (v = function(e, t, n, r) {
                        null == r && (r = 0),
                        e.options.lineWrapping || t != n || (n = "before" == t.sticky ? F(t.line, t.ch + 1, "before") : t,
                        ...
                        for (var i = 0; i < 5; i++) {
                            ...
                            if (null != s.scrollTop && (Ir(e, s.scrollTop),
                            1 < Math.abs(e.doc.scrollTop - a) && (l = !0)),
                            null != s.scrollLeft && (Rr(e, s.scrollLeft),
    ...
    function Zr(l) {
        ...
        c.iter(a.line, Math.min(c.first + c.size, l.display.viewTo + 500), function(e) {
            if (a.line >= l.display.viewFrom) {
                for (var t = e.styles, n = e.text.length > l.options.maxHighlightLength ? ht(c.mode, a.state) : null, r = Nt(l, e, a, !0), n = (n && (a.state = n),
                e.styles = r.styles,
                e.styleClasses), r = r.classes, i = (r ? e.styleClasses = r : n && (e.styleClasses = null),
                !t || t.length != e.styles.length || n != r && (!n || !r || n.bgClass != r.bgClass || n.textClass != r.textClass)), o = 0; !i && o < t.length; ++o)
                    i = t[o] != e.styles[o];
                i && u.push(a.line),
                e.stateAfter = a.save(),
                a.nextLine()
    ...
    function Jr(e, t) {
        ...
        var i = r.first + r.size
          ...
          , r = (n.viewFrom < o && o - n.viewFrom < 20 && (o = Math.max(r.first, n.viewFrom)),
        ...
        o != n.viewFrom || l != n.viewTo || n.lastWrapHeight != t.wrapperHeight || n.lastWrapWidth != t.wrapperWidth)
          , i = (i = o,
        o = l,
        0 == (c = (l = e).display).view.length || i >= c.viewTo || o <= c.viewFrom ? (c.view = mn(l, i, o),
        c.viewFrom = i) : (c.viewFrom > i ? c.view = mn(l, i, c.viewFrom).concat(c.view) : c.viewFrom < i && (c.view = c.view.slice(pr(l, i))),
        c.viewFrom = i,
        ...
        yr(e));
        if (!r && 0 == i && !t.force && n.renderedView == n.view && (null == n.updateLineNumbers || n.updateLineNumbers >= n.viewTo))
            return !1;
        var l = function(e) {
            if (e.hasFocus())
                return null;
            if (!(n = N(ae(e))) || !re(e.display.lineDiv, n))
                return null;
            var t, n = {
                activeElt: n
            };
            return window.getSelection && (t = ue(e).getSelection()).anchorNode && t.extend && re(e.display.lineDiv, t.anchorNode) && (n.anchorNode = t.anchorNode,
            n.anchorOffset = t.anchorOffset,
            n.focusNode = t.focusNode,
            n.focusOffset = t.focusOffset),
            n
        }(e)
          , s = (4 < i && (n.lineDiv.style.display = "none"),
        e)
        ...
        function p(e) {
            var t = e.nextSibling;
            return x && C && s.display.currentWheelTarget == e ? e.style.display = "none" : e.parentNode.removeChild(e),
            t
        }
        for (var g = c.view, m = c.viewFrom, v = 0; v < g.length; v++) {
            ...
            if (!y.hidden)
                if (y.node && y.node.parentNode == d) {
                    ...
                    y.changes && (-1 < L(y.changes, "gutter") && (b = !1),
                    wn(s, y, m, u)),
                    b && (te(y.lineNumber),
        ...
        for (; f; )
            f = p(f);
        return 4 < i && (n.lineDiv.style.display = ""),
        n.renderedView = n.view,
        (o = l) && o.activeElt && o.activeElt != N(o.activeElt.ownerDocument) && (o.activeElt.focus(),
        !/^(INPUT|TEXTAREA)$/.test(o.activeElt.nodeName) && o.anchorNode && re(document.body, o.anchorNode) && re(document.body, o.focusNode) && (i = (c = o.activeElt.ownerDocument).defaultView.getSelection(),
        ...
        r && (n.lastWrapHeight = t.wrapperHeight,
    ...
    function oi(e) {
        ...
        if (e.options.lineNumbers)
            ...
            n = e.display,
            t.length != n.lineNumChars ? (r = (i = n.measure.appendChild(M("div", [M("div", t)], "CodeMirror-linenumber CodeMirror-gutter-elt"))).firstChild.offsetWidth,
            i = i.offsetWidth - r,
    ...
    function si(e) {
        ...
        for (var r = 0; r < n.length; ++r) {
            ...
            i && (l.style.cssText = i),
            "CodeMirror-linenumbers" == o && ((e.lineGutter = l).style.width = (e.lineNumWidth || 1) + "px")
        }
    ...
    function pi(e, t) {
        m && 102 == V && (null == e.display.chromeScrollHack ? e.display.sizer.style.pointerEvents = "none" : clearTimeout(e.display.chromeScrollHack),
        ...
        if (r && s || n && a) {
            ...
            if (r && !d && !K && null != i)
                return n && a && Ir(e, Math.max(0, l.scrollTop + n * i)),
                Rr(e, Math.max(0, l.scrollLeft + r * i)),
                n && !a || D(t),
                void (o.wheelStartX = null);
            n && null != i && (a = (s = e.doc.scrollTop) + o.wrapper.clientHeight,
            (i = n * i) < 0 ? s = Math.max(0, s + i - 50) : a = Math.min(e.doc.height, a + i + 50),
            ti(e, {
                top: s,
                bottom: a
            })),
            ci < 20 && 0 !== t.deltaMode && (null == o.wheelStartX ? (o.wheelStartX = l.scrollLeft,
            o.wheelStartY = l.scrollTop,
            o.wheelDX = r,
            o.wheelDY = n,
            setTimeout(function() {
                var e, t;
                null != o.wheelStartX && (e = l.scrollLeft - o.wheelStartX,
    ...
    function gi(e, t, n) {
        ...
        for (var i = 1; i < t.length; i++) {
            ...
            (r && !l.empty() ? 0 < a : 0 <= a) && (a = St(s.from(), l.from()),
            o = Ct(s.to(), l.to()),
    ...
    function yi(e, t) {
        ...
        var n = e.line + t.text.length - (t.to.line - t.from.line) - 1
          , r = e.ch;
        return e.line == t.to.line && (r += vi(t).ch - t.to.ch),
        F(n, r)
    }
    function bi(e, t) {
    ...
    function xi(e) {
        e.doc.mode = at(e.options, e.doc.modeOption),
        Ci(e)
    }
    function Ci(e) {
    ...
    function Li(e, o, t, l) {
        ...
        function r(e, t) {
            for (var n = [], r = e; r < t; ++r)
                n.push(new sn(c[r],i(r),l));
            return n
        }
        var s, a = o.from, u = o.to, c = o.text, h = W(e, a.line), d = W(e, u.line), f = z(c), p = i(c.length - 1), g = u.line - a.line;
        o.full ? (e.insert(0, r(0, c.length)),
        e.remove(c.length, e.size - c.length)) : Si(e, o) ? (s = r(0, c.length - 1),
        n(d, d.text, p),
        g && e.remove(a.line, g),
        s.length && e.insert(a.line, s)) : h == d ? 1 == c.length ? n(h, h.text.slice(0, a.ch) + f + h.text.slice(u.ch), p) : ((s = r(1, c.length - 1)).push(new sn(f + h.text.slice(u.ch),p,l)),
    ...
    function Di(e, t, n, r) {
        var i, o, l = e.history, s = (l.undone.length = 0,
        +new Date);
        if ((l.lastOp == r || l.lastOrigin == t.origin && t.origin && ("+" == t.origin.charAt(0) && l.lastModTime > s - (e.cm ? e.cm.options.historyEventDelay : 500) || "*" == t.origin.charAt(0))) && (o = (o = l).lastOp == r ? (Ai(o.done),
        z(o.done)) : o.done.length && !z(o.done).ranges ? z(o.done) : 1 < o.done.length && !o.done[o.done.length - 2].ranges ? (o.done.pop(),
        z(o.done)) : void 0))
            i = z(o.changes),
            0 == P(t.from, t.to) && 0 == P(t.from, i.to) ? i.to = vi(t) : o.changes.push(Oi(e, t));
        else {
            var a = z(l.done);
            for (a && a.ranges || Hi(e.sel, l.done),
            o = {
                changes: [Oi(e, t)],
                generation: l.generation
            },
            l.done.push(o); l.done.length > l.undoDepth; )
                l.done.shift(),
                l.done[0].ranges || l.done.shift()
        }
        l.done.push(n),
    ...
    function Wi(e, t, n, r) {
        ...
        n == s.lastSelOp || a && s.lastSelOrigin == a && (s.lastModTime == s.lastSelTime && s.lastOrigin == a || (e = e,
        i = a,
        o = z(s.done),
        l = t,
        "*" == (i = i.charAt(0)) || "+" == i && o.ranges.length == l.ranges.length && o.somethingSelected() == l.somethingSelected() && new Date - e.history.lastSelTime <= (e.cm ? e.cm.options.historyEventDelay : 500))) ? s.done[s.done.length - 1] = t : Hi(t, s.done),
    ...
    function Ii(e, t, n) {
        for (var r = [], i = 0; i < e.length; ++i) {
            var o = e[i];
            if (o.ranges)
                r.push(n ? B.prototype.deepCopy.call(o) : o);
            else {
                var l = o.changes
                  , s = [];
                r.push({
                ...
                for (var a = 0; a < l.length; ++a) {
                    ...
                    t)
                        for (var h in c)
                            (u = h.match(/^spans_(\d+)$/)) && -1 < L(t, Number(u[1])) && (z(s)[h] = c[h],
                            delete c[h])
                }
            }
        }
    ...
    function zi(e, t, n, r) {
        return r ? (r = e.anchor,
        n && ((e = P(t, r) < 0) != P(n, r) < 0 ? (r = t,
        t = n) : e != P(t, n) < 0 && (t = n)),
        new G(r,t)) : new G(n || t,t)
    }
    ...
    function Gi(e, t, n, r) {
        ...
        i[t] = n,
        U(e, gi(e.cm, i, e.sel.primIndex), r)
    }
    function Ui(e, t, n, r) {
        U(e, mi(t, n), r)
    }
    ...
    function U(e, t, n) {
        Ki(e, t, n),
        Wi(e, e.sel, e.cm ? e.cm.curOp.id : NaN, n)
    }
    function Ki(e, t, n) {
        (je(e, "beforeSelectionChange") || e.cm && je(e.cm, "beforeSelectionChange")) && (r = e,
        o = n,
        o = {
            ranges: (i = t).ranges,
            update: function(e) {
                    ...
                    if (a.atomic) {
                        if (n) {
                            var s = a.find(r < 0 ? 1 : -1)
                              , h = void 0;
                            if ((s = (r < 0 ? c : u) ? qi(e, s, -r, s && s.line == t.line ? o : null) : s) && s.line == t.line && (h = P(s, n)) && (r < 0 ? h < 0 : 0 < h))
                                return $i(e, s, t, r, i)
                        }
                        h = a.find(r < 0 ? -1 : 1);
    ...
    function _i(e, t, n, r, i) {
        r = r || 1,
        i = $i(e, t, n, r, i) || !i && $i(e, t, n, r, !0) || $i(e, t, n, -r, i) || !i && $i(e, t, n, -r, !0);
        return i || (e.cantEdit = !0,
        F(e.first, 0))
    }
    function qi(e, t, n, r) {
            ...
            var r = zt && !n && function(e, t, n) {
                ...
                for (var i = [{
                    ...
                    for (var l = r[o], s = l.find(0), a = 0; a < i.length; ++a) {
                        var u, c, h, d = i[a];
                        P(d.to, s.from) < 0 || 0 < P(d.from, s.to) || (u = [a, 1],
                        c = P(d.from, s.from),
                        h = P(d.to, s.to),
    ...
    function eo(e, n) {
        var t, r;
        1 == n.text.length && "" == n.text[0] && 0 == P(n.from, n.to) || (t = bi(e, n),
        Di(e, n, t, e.cm ? e.cm.curOp.id : NaN),
        ro(e, n, t, Ut(e, n)),
        r = [],
        ki(e, function(e, t) {
            t || -1 != L(r, e.history) || (so(e.history, n),
            r.push(e.history)),
            ro(e, n, null, Ut(e, n))
        }))
    }
    function to(i, o, e) {
        ...
        if (!t || e) {
            ...
            if (u != s.length) {
                ...
                je(i, "beforeChange") || i.cm && je(i.cm, "beforeChange")), d = l.changes.length - 1; 0 <= d; --d) {
                    var f = function(e) {
                        var n = l.changes[e];
                        if (n.origin = o,
                        h && !Qi(i, n, !1))
    ...
    function no(e, t) {
        if (0 != t && (e.first += t,
        e.sel = new B(xe(e.sel.ranges, function(e) {
    ...
    function ro(e, t, n, r) {
        if (e.cm && !e.cm.curOp)
            return R(e.cm, ro)(e, t, n, r);
        if (t.to.line < e.first)
            no(e, t.text.length - 1 - (t.to.line - t.from.line));
        else if (!(t.from.line > e.lastLine())) {
            t.from.line < e.first && (no(e, i = t.text.length - 1 - (e.first - t.from.line)),
            t = {
                from: F(e.first, 0),
            ...
            e.cm) {
                var i = e.cm
                  ...
                  , h = !1
                  , d = u.line
                  , f = (i.options.lineWrapping || (d = H(Jt(W(s, u.line))),
                ...
                Li(s, o, l, hr(i)),
                i.options.lineWrapping || (s.iter(d, u.line + o.text.length, function(e) {
                    var t = on(e);
                    t > a.maxLineLength && (a.maxLine = e,
                    a.maxLineLength = t,
                    a.maxLineChanged = !0,
                    h = !1)
                }),
                ...
                s)
                  , p = u.line;
                if (f.modeFrontier = Math.min(f.modeFrontier, p),
    ...
    function ao(e, t, n, r) {
        var i = t
          , o = t;
        return "number" == typeof t ? o = W(e, Lt(e, t)) : i = H(t),
        null == i ? null : (r(o, i) && e.cm && gr(e.cm, i, n),
        o)
    }
    function uo(e) {
        this.lines = e,
    ...
    co.prototype = {
        ...
        removeInner: function(e, t) {
            ...
            this.size - t < 25 && (1 < this.children.length || !(this.children[0]instanceof uo)) && (this.collapse(n = []),
        ...
        maybeSpill: function() {
            if (!(this.children.length <= 10)) {
                ...
                e.parent.children.splice(t + 1, 0, n)) : (((t = new co(e.children)).parent = e).children = [t, n],
                e = t),
                n.parent = e.parent,
    ...
    ho.prototype.changed = function() {
        var e = this
          ...
          , i = (this.height = null,
        Mn(this) - t);
        i && (nn(this.doc, r) || mt(r, r.height + i),
        n && h(n, function() {
    ...
    function mo(r, i, o, e, t) {
        ...
        var n, l, s, a, u, c, h;
        if (r.cm && !r.cm.curOp)
            return R(r.cm, mo)(r, i, o, e, t);
        var d = new po(r,t)
          , f = P(i, o);
        if (e && he(e, d, !1),
        0 < f || 0 == f && !1 !== d.clearWhenEmpty)
            return d;
        if (d.replacedWith && (d.collapsed = !0,
        ...
        if (r.iter(g, o.line + 1, function(e) {
            ...
            (n = (n = r.cm && r.cm.curOp) && window.WeakSet && (n.markedSpans || (n.markedSpans = new WeakSet))) && e.markedSpans && n.has(e.markedSpans) ? e.markedSpans.push(t) : (e.markedSpans = e.markedSpans ? e.markedSpans.concat([t]) : [t],
    ...
    po.prototype.clear = function() {
        if (!this.explicitlyCleared) {
            for (var e, t = this.doc.cm, n = t && !t.curOp, r = (n && $r(t),
            !je(this, "clear") || (e = this.find()) && b(this, "clear", e.from, e.to),
            null), i = null, o = 0; o < this.lines.length; ++o) {
                var l = this.lines[o]
                  , s = Gt(l.markedSpans, this);
                t && !this.collapsed ? gr(t, H(l), "text") : t && (null != s.to && (i = H(l)),
                null != s.from && (r = H(l))),
    ...
    po.prototype.find = function(e, t) {
        ...
        for (var i = 0; i < this.lines.length; ++i) {
            ...
            if (null != l.from && (n = F(t ? o : H(o), l.from),
            -1 == e))
                return n;
            if (null != l.to && (r = F(t ? o : H(o), l.to),
            1 == e))
                return r
        }
        return n && {
    ...
    po.prototype.changed = function() {
        ...
        r && o && h(o, function() {
            ...
            nn(i.doc, e) || null == i.height || (t = i.height,
            i.height = null,
    ...
    po.prototype.attachLine = function(e) {
        var t;
        this.lines.length || !this.doc.cm || (t = this.doc.cm.curOp).maybeHiddenMarkers && -1 != L(t.maybeHiddenMarkers, this) || (t.maybeUnhiddenMarkers || (t.maybeUnhiddenMarkers = [])).push(this),
        this.lines.push(e)
    }
    ,
      ...
      , xo = ((f.prototype = Se(co.prototype, {
            ...
            for (var t = t && "end" != t && function(e, t, n) {
                for (var r = [], i = u = F(e.first, 0), o = 0; o < t.length; o++) {
                    var l = t[o]
                      ...
                      , u = l.to
                      , i = a;
                    "around" == n ? (l = P((l = e.sel.ranges[o]).head, l.anchor) < 0,
                    r[o] = new G(l ? a : s,l ? s : a)) : r[o] = new G(s,s)
                }
        ...
        setGutterMarker: n(function(e, n, r) {
            return ao(this, e, "gutter", function(e) {
                ...
                return !(t[n] = r) && Me(t) && (e.gutterMarkers = null),
                1
            })
        }),
        ...
        linkedDoc: function(e) {
            for (var t = this.first, n = this.first + this.size, n = (null != (e = e || {}).from && e.from > t && (t = e.from),
            null != e.to && e.to < n && (n = e.to),
            new f(gt(this, t, n),e.mode || this.modeOption,t,this.lineSep,this.direction)), r = (e.sharedHist && (n.history = this.history),
            ...
            n), i = yo(this), o = 0; o < i.length; o++) {
                var l = i[o]
                  ...
                  , a = r.clipPos(s.from)
                  , s = r.clipPos(s.to);
                P(a, s) && (a = mo(r, a, s, l.primary, l.primary.type),
                l.markers.push(a),
                a.parent = l)
            }
            return n
                ...
                if (n && n.length && window.FileReader && window.File)
                    for (var i = n.length, o = Array(i), l = 0, s = function() {
                        ++l == i && R(r, function() {
                            ...
                            Ji(r.doc, e),
                            Vi(r.doc, mi(E(r.doc, t), E(r.doc, vi(e))))
                        })()
                    }, a = 0; a < n.length; a++)
                        !function(e, t) {
                            var n;
    ...
    for (var Ao = 65; Ao <= 90; Ao++)
        No[Ao] = String.fromCharCode(Ao);
    for (var Do = 1; Do <= 12; Do++)
        No[Do + 111] = No[Do + 63235] = "F" + Do;
    var Wo = {};
    function Ho(e) {
    ...
    function Vo(e, t, n, r, i) {
        if (e) {
            ...
            if (e)
                return o = i < 0 == (1 == (e = i < 0 ? z(e) : e[0]).level) ? "after" : "before",
                0 < e.level || "rtl" == t.doc.direction ? (l = zn(t, n),
                s = i < 0 ? n.text.length - 1 : 0,
                a = Rn(t, l, s).top,
                s = De(function(e) {
                    return Rn(t, l, e).top == a
                }, i < 0 == (1 == e.level) ? e.from : e.to - 1, s),
                "before" == o && (s = Go(n, s, 1))) : s = i < 0 ? e.to : e.from,
                new F(r,s,o)
        }
    ...
    function Ko(t, n, s, e) {
        ...
        function o(e) {
            return t.options.lineWrapping ? (l = l || zn(t, n),
            rr(t, n, l, e)) : {
                begin: 0,
                end: n.text.length
            }
    ...
    var jo = {
        ...
        killLine: function(n) {
            return Bo(n, function(e) {
                var t;
                return e.empty() ? (t = W(n.doc, e.head.line).text.length,
        ...
        transposeChars: function(l) {
            return h(l, function() {
                for (var e, t, n, r = l.listSelections(), i = [], o = 0; o < r.length; o++)
                    ...
                    (t = W(l.doc, e.line).text) && (0 < (e = e.ch == t.length ? new F(e.line,e.ch - 1) : e).ch ? (e = new F(e.line,e.ch + 1),
                    l.replaceRange(t.charAt(e.ch - 1) + t.charAt(e.ch - 2), F(e.line, e.ch - 2), e, "+transpose")) : e.line > l.doc.first && ((n = W(l.doc, e.line - 1).text) && (e = new F(e.line,1),
                    l.replaceRange(t.charAt(0) + l.doc.lineSeparator() + n.charAt(n.length - 1), F(e.line - 1, n.length - 1), e, "+transpose")))),
                    i.push(new G(e,e)));
                l.setSelections(i)
            })
        },
    ...
    function Yo(e, t) {
        ...
        return e && 0 != e[0].level ? n : (e = Math.max(n.ch, r.text.search(/\S/)),
    ...
    function el(e) {
        var t, n, r, i = this;
        function o(e) {
            18 != e.keyCode && e.altKey || (ee(r, "CodeMirror-crosshair"),
            T(document, "keyup", o),
            T(document, "mouseover", o))
        }
        e.target && e.target != i.display.input.getField() || (i.curOp.focus = N(ae(i)),
        A(i, e) || (w && v < 11 && 27 == e.keyCode && (e.returnValue = !1),
        t = e.keyCode,
        i.display.shift = 16 == t || e.shiftKey,
        n = Qo(i, e),
        K && (Jo = n ? t : null,
        !n && 88 == t && !rt && (C ? e.metaKey : e.ctrlKey) && i.replaceSelection("", null, "cut")),
        d && !C && !n && 46 == t && e.shiftKey && !e.ctrlKey && document.execCommand && document.execCommand("cut"),
        18 != t || /\bCodeMirror-crosshair\b/.test(i.display.lineDiv.className) || (ie(r = i.display.lineDiv, "CodeMirror-crosshair"),
        k(document, "keyup", o),
    ...
    function ll(e) {
        ...
        A(c, e) || h.activeTouch && h.input.supportsTouch() || (h.input.ensurePolled(),
        h.shift = e.shiftKey,
        Nn(h, e) ? x || (h.scroller.draggable = !1,
        setTimeout(function() {
        ...
        o = n,
        r = +new Date,
        ol && ol.compare(r, i, o) ? (il = ol = null,
        "triple") : il && il.compare(r, i, o) ? (ol = new rl(r,i,o),
        il = null,
        "double") : (il = new rl(r,i,o),
        ol = null,
        "single")) : "single",
        ue(c).focus(),
        ...
        a = function(e, t, n) {
            ...
            {
                var i;
                null == r.unit && (i = q ? n.shiftKey && n.metaKey : n.altKey,
        ...
        u = i.doc.sel,
        (i.options.dragDrop && et && !i.isReadOnly() && "single" == l && -1 < (l = u.contains(o)) && (P((l = u.ranges[l]).from(), o) < 0 || 0 < o.xRel) && (0 < P(l.to(), o) || o.xRel < 0) ? function(t, n, r, i) {
            var o = t.display
              , l = !1
              , s = R(t, function(e) {
        ...
        : function(d, e, f, p) {
            ...
            m = -1 < v ? t[v] : new G(f,f)) : (m = g.sel.primary(),
            v = g.sel.primIndex);
            "rectangle" == p.unit ? (p.addNew || (m = new G(f,f)),
            f = fr(d, e, !0, !0),
            v = -1) : (e = sl(d, f, p.unit),
            ...
            y = g.sel) : Gi(g, v, m, me) : (U(g, new B([m],v = 0), me),
            y = g.sel);
            var b = f;
            function s(e) {
                if (0 != P(b, e))
                    ...
                    "rectangle" == p.unit) {
                        ...
                        var h, r = m, i = sl(d, e, p.unit), e = r.anchor, e = 0 < P(i.anchor, e) ? (h = i.head,
                        St(r.from(), i.anchor)) : (h = i.anchor,
                        Ct(r.to(), i.head)), r = y.ranges.slice(0);
                        r[v] = function(e, t) {
                            var n = t.anchor
                              , r = t.head
                              , i = W(e.doc, n.line);
                            ...
                            if (0 == s || s == i.length)
                                return t;
                            l = r.line != n.line ? 0 < (r.line - n.line) * ("ltr" == e.doc.direction ? 1 : -1) : (e = He(i, r.ch, r.sticky),
            ...
            var r = R(d, function(e) {
                (0 !== e.buttons && Ze(e) ? function e(t) {
                    ...
                    o && (0 != P(o, b) ? (d.curOp.focus = N(ae(d)),
                    s(o),
                    n = Ar(l, g),
                    (o.line >= n.to || o.line < n.from) && setTimeout(R(d, function() {
                        u == i && e(t)
        ...
        )(i, s, o, a)) : qe(e) == h.scroller && D(e) : 2 == n ? (t && Ri(c.doc, t),
        setTimeout(function() {
    ...
    function sl(e, t, n) {
        ...
        if ("line" == n)
            return new G(F(t.line, 0),E(e.doc, F(t.line + 1, 0)));
        n = n(e, t);
    ...
    function cl(e, t) {
        var n, r;
        Nn(e.display, t) || (r = t,
        je(n = e, "gutterContextMenu") && al(n, r, "gutterContextMenu", !1)) || A(e, t, "contextmenu") || Q || e.display.input.onContextMenu(t)
    }
    function hl(e) {
    ...
    var dl = {
      ...
      , pl = {};
    function gl(e, t, n) {
        !t != !(n && n != dl) && (n = e.display.dragFunctions,
    ...
    function ml(e) {
        e.options.lineWrapping ? (ie(e.display.wrapper, "CodeMirror-wrap"),
        e.display.sizer.style.minWidth = "",
        e.display.sizerWidth = null) : (ee(e.display.wrapper, "CodeMirror-wrap"),
        ln(e)),
        dr(e),
        I(e),
        jn(e),
    ...
    function p(e, t) {
        ...
        if (!(this instanceof p))
            return new p(e,t);
        this.options = t = t ? he(t) : {},
        he(fl, t, !1);
        var r, i = t.value, o = ("string" == typeof i ? i = new f(i,t.mode,null,t.lineSeparator,t.direction) : t.mode && (i.modeOption = t.mode),
        this.doc = i,
        new p.inputStyles[t.inputStyle](this)), e = this.display = new ui(e,i,o,t), l = (hl(e.wrapper.CodeMirror = this),
        ...
        k(s.scroller, "dblclick", w && v < 11 ? R(l, function(e) {
            var t;
            A(l, e) || (!(t = fr(l, e)) || ul(l, e) || Nn(l.display, e) || (D(e),
            e = l.findWordAt(t),
        ...
        k(s.scroller, "touchstart", function(e) {
            ...
            1 == e.touches.length && (s.activeTouch.left = e.touches[0].pageX,
        ...
        k(s.scroller, "touchend", function(e) {
            ...
            n && !Nn(s, e) && null != n.left && !n.moved && new Date - n.start < 300 && (t = l.coordsChar(s.activeTouch, "page"),
        ...
        k(s.scroller, "scroll", function() {
            s.scroller.clientHeight && (Ir(l, s.scroller.scrollTop),
        ...
        s.dragFunctions = {
            ...
            over: function(e) {
                var t, n;
                A(l, e) || ((n = fr(t = l, n = e)) && (xr(t, n, n = document.createDocumentFragment()),
            ...
            start: function(e) {
                ...
                t = l,
                e = e,
                w && (!t.state.draggingText || +new Date - xo < 100) ? _e(e) : A(t, e) || Nn(t.display, e) || (e.dataTransfer.setData("Text", t.getSelection()),
                e.dataTransfer.effectAllowed = "copyMove",
                e.dataTransfer.setDragImage && !j && ((n = M("img", null, null, "position: fixed; left: 0; top: 0;")).src = "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==",
                K && (n.width = n.height = 1,
        ...
        Ti(this, i),
        t.autofocus && !_ || this.hasFocus() ? setTimeout(function() {
        ...
        for (var d = 0; d < vl.length; ++d)
            vl[d](this);
        _r(this),
        x && t.lineWrapping && "optimizelegibility" == getComputedStyle(e.lineDiv).textRendering && (e.lineDiv.style.textRendering = "auto")
    }
    p.defaults = fl,
    p.optionHandlers = pl;
    var vl = [];
    function yl(e, t, n, r) {
        var i, o = e.doc, l = ("smart" == (n = null == n ? "add" : n) && (o.mode.indent ? i = At(e, t).state : n = "prev"),
        e.options.tabSize), s = W(o, t), a = S(s.text, null, l), u = (s.stateAfter && (s.stateAfter = null),
        s.text.match(/^\s*/)[0]);
        if (r || /\S/.test(s.text)) {
        ...
        if (d < c && (h += we(c - d)),
        h != u)
            return io(o, h, F(t, 0), F(t, u.length), "+input"),
            !(s.stateAfter = null);
    ...
    function xl(e, t, n, r, i) {
        ...
        if (s && 1 < r.ranges.length)
            if (bl && bl.text.join("\n") == t) {
                ...
                a.length == r.ranges.length && e.options.pasteLinesPerSelection && (u = xe(a, function(e) {
                    return [e]
                }));
    ...
    function Cl(e, t) {
        ...
        t.isReadOnly() || t.options.disableInput || !t.hasFocus() || h(t, function() {
            ...
            for (var n = e.doc.sel, r = n.ranges.length - 1; 0 <= r; r--) {
                ...
                if (!(100 < i.head.ch || r && n.ranges[r - 1].head.line == i.head.line)) {
                    ...
                    if (o.electricChars) {
                        ...
                        o.electricInput && o.electricInput.test(W(e.doc, i.head.line).text.slice(0, i.head.ch)) && (l = yl(e, i.head.line, "smart"));
    ...
    function Tl() {
        ...
        return x ? e.style.width = "1000px" : e.setAttribute("wrap", "off"),
    ...
    function Ml(n, r, i, o, l) {
        ...
        function u(e) {
            var t;
            if (null == (t = "codepoint" == o ? (t = s.text.charCodeAt(r.ch + (0 < i ? 0 : -1)),
            isNaN(t) ? null : (t = 0 < i ? 55296 <= t && t < 56320 : 56320 <= t && t < 57343,
            new F(r.line,Math.max(0, Math.min(s.text.length, r.ch + i * (t ? 2 : 1))),-i))) : l ? Ko(n.cm, s, r, i) : Uo(s, r, i))) {
                if (e || (e = r.line + a) < n.first || e >= n.first + n.size || (r = new F(e,r.ch,r.sticky),
                !(s = W(n, e))))
                    return;
        ...
        t = _i(n, r, e, t, !0);
        return wt(e, t) && (t.hitSide = !0),
        t
    }
    function Nl(e, t, n, r) {
        var i, o, l, s = e.doc, a = t.left;
        for ("page" == r ? (i = Math.min(e.display.wrapper.clientHeight, ue(e).innerHeight || s(e).documentElement.clientHeight),
        i = Math.max(i - .5 * sr(e.display), 3),
        o = (0 < n ? t.bottom : t.top) + n * i) : "line" == r && (o = 0 < n ? t.bottom + 3 : t.top - 3); (l = tr(e, a, o)).outside; ) {
    ...
    function Ol(e, t) {
        ...
        var r = W(e.doc, t.line)
          ...
          , e = "left"
          , r = (r && (e = He(r, t.ch) % 2 ? "right" : "left"),
        Un(n.map, t.ch, e));
        return r.offset = "right" == r.collapse ? r.end : r.start,
        r
    }
    function Al(e, t) {
        return t && (e.bad = !0),
        ...
        for (var i = 0; i < e.display.view.length; i++) {
            ...
            if (o.node == r) {
                ...
                var c = 3 == o.nodeType ? o : null
                  , h = o;
                for (c || 1 != o.childNodes.length || 3 != o.firstChild.nodeType || (c = o.firstChild,
                l = l && c.nodeValue.length); h.parentNode != s; )
                    h = h.parentNode;
                var d = u.measure
                  , f = d.maps;
                function p(e, t, n) {
                    for (var r = -1; r < (f ? f.length : 0); r++)
                        for (var i = r < 0 ? d.map : f[r], o = 0; o < i.length; o += 3) {
                            var l, s, a = i[o + 2];
                            if (a == e || a == t)
                                return l = H(r < 0 ? u.line : u.rest[r]),
                                s = i[o] + n,
    ...
    r.prototype.init = function(e) {
        ...
        function n(e) {
            if (a(e) && !A(l, e)) {
                ...
                var r = Tl()
                  , n = r.firstChild
                  , i = (l.display.lineSpace.insertBefore(r, l.display.lineSpace.firstChild),
        ...
        if (t.display.viewTo == t.display.viewFrom || r.line >= t.display.viewTo || n.line < t.display.viewFrom)
            ...
            if (!i || i.bad || !o || o.bad || 0 != P(St(i, o), r) || 0 != P(Ct(i, o), n)) {
                ...
                o && r) {
                    ...
                    l && (!d && t.state.focused ? (e.collapse(o.node, o.offset),
    ...
    r.prototype.pollContent = function() {
        ...
        if (0 == i.ch && i.line > t.firstLine() && (i = F(i.line - 1, W(t.doc, i.line - 1).length)),
        r.ch == W(t.doc, r.line).text.length && r.line < t.lastLine() && (r = F(r.line + 1, 0)),
        i.line < n.viewFrom || r.line > n.viewTo - 1)
            return !1;
        var o, l = i.line == n.viewFrom || 0 == (l = pr(t, i.line)) ? (e = H(n.view[0].line),
        n.view[0].node) : (e = H(n.view[l].line),
        n.view[l - 1].node.nextSibling), r = pr(t, r.line), n = r == n.view.length - 1 ? (o = n.viewTo - 1,
        n.lineDiv.lastChild) : (o = H(n.view[r + 1].line) - 1,
            ...
            for (; !function e(t) {
                if (1 == t.nodeType) {
                    ...
                    if (n)
                        ...
                        (n = o.findMarks(F(l, 0), F(s + 1, 0), (i = +n,
                        function(e) {
                            return e.id == i
                        }
                        ))).length && (n = n[0].find(0)) && d(pt(o.doc, n.from, n.to).join(u));
                    else if ("false" != t.getAttribute("contenteditable") && (n = /^(pre|div|p|li|table|br)$/i.test(t.nodeName),
                    /^br$/i.test(t.nodeName) || 0 != t.textContent.length)) {
                        n && h();
                        for (var r = 0; r < t.childNodes.length; r++)
                            e(t.childNodes[r]);
                        /^(pre|p)$/i.test(t.nodeName) && (c = !0),
                        n && (a = !0)
                    }
                } else
        ...
        for (var u = 0, c = 0, h = s[0], d = a[0], f = Math.min(h.length, d.length); u < f && h.charCodeAt(u) == d.charCodeAt(u); )
            ++u;
        for (var p = z(s), g = z(a), m = Math.min(p.length - (1 == s.length ? u : 0), g.length - (1 == a.length ? u : 0)); c < m && p.charCodeAt(p.length - c - 1) == g.charCodeAt(g.length - c - 1); )
            ++c;
        ...
        r = F(e, u),
        l = F(o, a.length ? z(a).length - c : 0);
        return 1 < s.length || s[0] || P(r, l) ? (io(t.doc, s, r, l, "+input"),
        !0) : void 0
    }
    ,
    ...
    r.prototype.onKeyPress = function(e) {
        ...
        this.cm.isReadOnly() || R(this.cm, xl)(this.cm, String.fromCharCode(null == e.charCode ? e.keyCode : e.charCode), 0))
    }
    ,
    ...
    i.prototype.init = function(n) {
        ...
        function t(e) {
            if (!A(i, e)) {
                if (i.somethingSelected())
                    ...
                    "cut" == e.type ? i.setSelections(t.ranges, null, ge) : (r.prevInput = "",
                    o.value = t.text.join("\n"),
                    se(o))
                }
        ...
        k(o, "paste", function(e) {
            A(i, e) || Cl(e, i) || (i.state.pasteIncoming = +new Date,
            r.fastPoll())
        }),
        k(o, "cut", t),
        k(o, "copy", t),
    ...
    i.prototype.prepareSelection = function() {
        ...
        return t.options.moveInputWithCursor && (t = Qn(t, r.sel.primary().head, "div"),
    ...
    i.prototype.poll = function() {
        var e = this
          ...
          , n = this.textarea
          , r = this.prevInput;
        if (this.contextMenuPending || !t.state.focused || nt(n) && !r && !this.composing || t.isReadOnly() || t.options.disableInput || t.state.keySeq)
            return !1;
        var i = n.value;
    ...
    i.prototype.onContextMenu = function(e) {
        var n, r, t, i, o = this, l = o.cm, s = l.display, a = o.textarea, u = (o.contextMenuPending && o.contextMenuPending(),
        fr(l, e)), c = s.scroller.scrollTop;
        function h() {
            var e, t;
            null != a.selectionStart && (t = "​" + ((e = l.somethingSelected()) ? a.value : ""),
            a.value = "⇚",
            a.value = t,
            o.prevInput = e ? "" : "​",
            a.selectionStart = 1,
        ...
        function d() {
            var e, t;
            o.contextMenuPending == d && (o.contextMenuPending = !1,
            o.wrapper.style.cssText = r,
            a.style.cssText = n,
            w && v < 9 && s.scrollbars.setScrollTop(s.scroller.scrollTop = c),
            null != a.selectionStart && ((!w || v < 9) && h(),
            e = 0,
            t = function() {
                s.selForContextMenu == l.doc.sel && 0 == a.selectionStart && 0 < a.selectionEnd && "​" == o.prevInput ? R(l, Zi)(l) : e++ < 10 ? s.detectingSelectAll = setTimeout(t, 500) : (s.selForContextMenu = null,
                s.input.reset())
            }
            ,
            s.detectingSelectAll = setTimeout(t, 200)))
        }
        u && !K && (l.options.resetSelectionOnContextMenu && -1 == l.doc.sel.contains(u) && R(l, U)(l.doc, mi(u), ge),
        n = a.style.cssText,
    ...
    o("electricChars", !0),
    o("inputStyle", _ ? "contenteditable" : "textarea", function() {
        throw new Error("inputStyle can not (yet) be changed in a running editor")
    }, !0),
    o("spellcheck", !1, function(e, t) {
        return e.getInputField().spellcheck = t
    }, !0),
    o("autocorrect", !1, function(e, t) {
        return e.getInputField().autocorrect = t
    }, !0),
    o("autocapitalize", !1, function(e, t) {
        return e.getInputField().autocapitalize = t
    }, !0),
    o("rtlMoveVisually", !a),
    o("wholeLineUpdateBefore", !0),
    o("theme", "default", function(e) {
        hl(e),
        ai(e)
    }, !0),
    ...
    o("gutters", [], function(e, t) {
        e.display.gutterSpecs = li(t, e.options.lineNumbers),
        ai(e)
    }, !0),
    o("fixedGutter", !0, function(e, t) {
        e.display.gutters.style.left = t ? cr(e.display) + "px" : "0",
        e.refresh()
    }, !0),
    o("coverGutterNextToScrollbar", !1, function(e) {
        return Vr(e)
    }, !0),
    o("scrollbarStyle", "native", function(e) {
        Xr(e),
        Vr(e),
        e.display.scrollbars.setScrollTop(e.doc.scrollTop),
        e.display.scrollbars.setScrollLeft(e.doc.scrollLeft)
    }, !0),
    o("lineNumbers", !1, function(e, t) {
        e.display.gutterSpecs = li(e.options.gutters, t),
        ai(e)
    }, !0),
    o("firstLineNumber", 1, ai, !0),
    o("lineNumberFormatter", function(e) {
        return e
    }, ai, !0),
    ...
    o("viewportMargin", 10, function(e) {
        return e.refresh()
    }, !0),
    ...
    Fl.prototype = {
        ...
        indentSelection: t(function(e) {
            for (var t = this.doc.sel.ranges, n = -1, r = 0; r < t.length; r++) {
                var i = t[r];
                if (i.empty())
                    i.head.line > n && (yl(this, i.head.line, e, !0),
                    n = i.head.line,
                    r == this.doc.sel.primIndex && Hr(this));
                else {
                    for (var o = i.from(), i = i.to(), l = Math.max(n, o.line), n = Math.min(this.lastLine(), i.line - (i.ch ? 0 : 1)) + 1, s = l; s < n; ++s)
                        yl(this, s, e);
        ...
        heightAtLine: function(e, t, n) {
            var r = !1
              , i = "number" == typeof e ? (i = this.doc.first + this.doc.size - 1,
        ...
        addWidget: function(e, t, n, r, i) {
            ...
            "over" == r ? a = e.top : "above" != r && "near" != r || (l = Math.max(s.wrapper.clientHeight, this.doc.height),
        ...
        findPosH: function(e, t, n, r) {
            for (var i = 1, o = (t < 0 && (i = -1,
            t = -t),
            E(this.doc, e)), l = 0; l < t && !(o = Ml(this.doc, o, i, n, r)).hitSide; ++l)
                ;
            return o
        },
        ...
        findPosV: function(e, t, n, r) {
            for (var i = 1, o = r, l = (t < 0 && (i = -1,
            t = -t),
            E(this.doc, e)), s = 0; s < t; ++s) {
                var a = Qn(this, l, "div");
        ...
        moveV: t(function(r, i) {
            ...
            if (l.extendSelectionsBy(function(e) {
                ...
                var t = Qn(o, e.head, "div")
                  , n = (null != e.goalColumn && (t.left = e.goalColumn),
                s.push(t.left),
                Nl(o, t, r, i));
                return "page" == i && e == l.sel.primary() && Wr(o, Zn(o, n, "div").top - t.top),
                n
            }, ve),
            s.length)
        ...
        findWordAt: function(e) {
            var t = W(this.doc, e.line).text
              ...
              , r = e.ch;
            if (t) {
                for (var i = this.getHelper(e, "wordChars"), o = ("before" != e.sticky && r != t.length || !n ? ++r : --n,
                t.charAt(n)), l = Te(o, i) ? function(e) {
                    return Te(e, i)
                }
                : /\s/.test(o) ? function(e) {
                    return /\s/.test(e)
        ...
        toggleOverwrite: function(e) {
            null != e && e == this.state.overwrite || (((this.state.overwrite = !this.state.overwrite) ? ie : ee)(this.display.cursorDiv, "CodeMirror-overwrite"),
        ...
        scrollIntoView: t(function(e, t) {
            ...
            e.to || (e.to = e.from),
            e.margin = t || 0,
            null != e.from.line ? (t = e,
            Pr(n = this),
            n.curOp.scrollToPos = t) : Er(this, e.from, e.to, e.margin)
        }),
        setSize: t(function(e, t) {
            ...
            var r = this
              , i = (null != e && (this.display.wrapper.style.width = n(e)),
        ...
        refresh: t(function() {
            ...
            ni(this.display),
            (null == e || .5 < Math.abs(e - sr(this.display)) || this.options.lineWrapping) && dr(this),
            O(this, "refresh", this)
        }),
    ...
    for (Il in f.prototype)
        f.prototype.hasOwnProperty(Il) && L(zl, Il) < 0 && (p.prototype[Il] = function(e) {
            return function() {
