    ...
    e.defineMode("brainfuck", function() {
        return {
            ...
            token: function(e, n) {
                ...
                return -1 === o.indexOf(t) ? (n.commentLine = !0,
                e.eol() && (n.commentLine = !1),
                "comment") : !0 === n.commentLine ? (e.eol() && (n.commentLine = !1),
                "comment") : "]" === t || "[" === t ? ("[" === t ? n.left++ : n.right++,
                "bracket") : "+" === t || "-" === t ? "keyword" : "<" === t || ">" === t ? "atom" : "." === t || "," === t ? "def" : void (e.eol() && (n.commentLine = !1))
            }
        }
    }),
