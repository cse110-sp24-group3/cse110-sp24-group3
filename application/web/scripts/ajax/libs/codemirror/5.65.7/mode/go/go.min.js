!function(e) {
    ...
    p.defineMode("go", function(e) {
        ...
        function u(e, t) {
            ...
            e.eatWhile(/[\w\$_\xa1-\uffff]/);
            t = e.current();
            return r.propertyIsEnumerable(t) ? ("case" != t && "default" != t || (i = "case"),
            "keyword") : a.propertyIsEnumerable(t) ? "atom" : "variable"
        }
        function l(e, t) {
        ...
        function d(e) {
            var t;
            e.context.prev && (")" != (t = e.context.type) && "]" != t && "}" != t || (e.indented = e.context.indented),
        ...
        return {
            ...
            token: function(e, t) {
                ...
                return "comment" == r || (null == n.align && (n.align = !0),
                "{" == i ? s(t, e.column(), "}") : "[" == i ? s(t, e.column(), "]") : "(" == i ? s(t, e.column(), ")") : "case" == i ? n.type = "case" : ("}" == i && "}" == n.type || i == n.type) && d(t),
                t.startOfLine = !1),
                r
            },
            indent: function(e, t) {
