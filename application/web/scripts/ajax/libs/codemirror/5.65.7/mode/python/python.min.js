!function(e) {
    ...
    x.defineMode("python", function(t, l) {
        for (var s = "error", o = l.delimiters || l.singleDelimiters || /^[\(\)\[\]\{\}@,:`=;\.\\]/, a = [l.singleOperators, l.doubleOperators, l.doubleDelimiters, l.tripleDelimiters, l.operators || /^([-+*/%\/&|^]=?|[<>=]+|\/\/=?|\*\*=?|!=|[~!@]|\.\.\.)/], e = 0; e < a.length; e++)
            a[e] || a.splice(e--, 1);
        var c, u, f = l.hangingIndent || t.indentUnit, n = v, r = z, p = (null != l.extra_keywords && (n = n.concat(l.extra_keywords)),
        null != l.extra_builtins && (r = r.concat(l.extra_builtins)),
        !(l.version && Number(l.version) < 3)), d = (u = p ? (c = l.identifiers || /^[_A-Za-z\u00A1-\uFFFF][_A-Za-z0-9\u00A1-\uFFFF]*/,
        n = n.concat(["nonlocal", "False", "True", "None", "async", "await"]),
        r = r.concat(["ascii", "bytes", "exec", "print"]),
        new RegExp("^(([rbuf]|(br)|(rb)|(fr)|(rf))?('{3}|\"{3}|['\"]))","i")) : (c = l.identifiers || /^[_A-Za-z][_A-Za-z0-9]*/,
        ...
        function i(e, t) {
            ...
            return r && (t.indent = e.indentation()),
            r && "py" == w(t).type ? (r = w(t).offset,
            e.eatSpace() ? (r < (n = e.indentation()) ? b(t) : n < r && y(e, t) && "#" != e.peek() && (t.errorToken = !0),
            null) : (n = h(e, t),
            0 < r && y(e, t) && (n += " " + s),
            n)) : h(e, t)
        }
        function h(e, t, n) {
            ...
            if (e.match(/^[0-9\.]/, !1)) {
                var r = !1;
                if (e.match(/^[\d_]*\.\d+(e[\+\-]?\d+)?/i) && (r = !0),
                e.match(/^[\d_]+\.\d*/) && (r = !0),
                r = e.match(/^\.\d+/) ? !0 : r)
                    return e.eat(/J/i),
                    "number";
                r = !1;
                if (e.match(/^0x[0-9a-f_]+/i) && (r = !0),
            ...
            if (e.match(u))
                return r = -1 !== e.current().toLowerCase().indexOf("f"),
                t.tokenize = (r ? function(n, r) {
                        ...
                        for (; !e.eol(); )
                            ...
                            e.eat("\\")) {
                                ...
                                if (e.match("{{"))
                                    return o;
                                if (e.match("{", !1))
                                    return t.tokenize = function r(i) {
                                        return function(e, t) {
                                            var n = h(e, t, !0);
                                            return "punctuation" == n && ("{" == e.current() ? t.tokenize = r(i + 1) : "}" == e.current() && (t.tokenize = 1 < i ? r(i - 1) : a)),
                                            n
                                        }
                                    }(0),
            ...
            for (var i = 0; i < a.length; i++)
                if (e.match(a[i]))
                    return "operator";
            return e.match(o) ? "punctuation" : "." == t.lastToken && e.match(c) ? "property" : e.match(d) || e.match(_) ? "keyword" : e.match(m) ? "builtin" : e.match(/^(self|cls)\b/) ? "variable-2" : e.match(c) ? "def" == t.lastToken || "class" == t.lastToken ? "def" : "variable" : (e.next(),
            n ? null : s)
        }
        function b(e) {
            for (; "py" != w(e).type; )
        ...
        function g(e, t) {
            ...
            if (/\S/.test(a) && (t.beginningOfLine = !1),
            "variable" != o && "builtin" != o || "meta" != t.lastToken || (o = "meta"),
            "pass" != a && "return" != a || (t.dedent = !0),
            "lambda" == a && (t.lambda = !0),
            ":" == a && !t.lambda && "py" == w(t).type && e.match(/^\s*(?:#|$)/, !1) && b(t),
            ...
            return t.dedent && e.eol() && "py" == w(t).type && 1 < t.scopes.length && t.scopes.pop(),
            o
        }
        return {
            ...
            token: function(e, t) {
                var n = t.errorToken
                  , r = (n && (t.errorToken = !1),
                g(e, t));
                return r && "comment" != r && (t.lastToken = "keyword" == r || "punctuation" == r ? e.current() : r),
