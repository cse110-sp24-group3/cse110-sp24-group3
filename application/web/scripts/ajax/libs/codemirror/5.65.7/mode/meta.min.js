!function(e) {
    ...
    for (var e = 0; e < i.modeInfo.length; e++) {
        var m = i.modeInfo[e];
        m.mimes && (m.mime = m.mimes[0])
    }
    i.findModeByMIME = function(e) {
        e = e.toLowerCase();
        for (var m = 0; m < i.modeInfo.length; m++) {
            var t = i.modeInfo[m];
            if (t.mime == e)
                return t;
            if (t.mimes)
                for (var a = 0; a < t.mimes.length; a++)
                    if (t.mimes[a] == e)
                        return t
        }
        return /\+xml$/.test(e) ? i.findModeByMIME("application/xml") : /\+json$/.test(e) ? i.findModeByMIME("application/json") : void 0
    }
    ,
    i.findModeByExtension = function(e) {
        e = e.toLowerCase();
        for (var m = 0; m < i.modeInfo.length; m++) {
            var t = i.modeInfo[m];
            if (t.ext)
    ...
    ,
    i.findModeByFileName = function(e) {
        for (var m = 0; m < i.modeInfo.length; m++) {
            var t = i.modeInfo[m];
            if (t.file && t.file.test(e))
                return t
        }
        var a = e.lastIndexOf(".")
          , a = -1 < a && e.substring(a + 1, e.length);
        if (a)
            return i.findModeByExtension(a)
    }
    ,
    i.findModeByName = function(e) {
        e = e.toLowerCase();
        for (var m = 0; m < i.modeInfo.length; m++) {
            var t = i.modeInfo[m];
            if (t.name.toLowerCase() == e)
                return t;
            if (t.alias)
                for (var a = 0; a < t.alias.length; a++)
                    if (t.alias[a].toLowerCase() == e)
                        return t
        }
    }
});
